...
public enum ResponseCodeEnum {
    ...
    USER_ADD_PRODUCT_NUMBER_FORMAT_ERROR(ResponseCode.RESPONSE_CODE_USER_ADD_CHECK_NG, "添加可访问的海关/商品编码格式不正确。"),
    USER_ADD_PRODUCT_NUMBER_IS_NOT_NUMERIC(ResponseCode.RESPONSE_CODE_USER_ADD_CHECK_NG, "添加可访问的海关/商品编码不是数字。"),
    ...
    USER_UPDATE_PRODUCT_NUMBER_FORMAT_ERROR(ResponseCode.RESPONSE_CODE_USER_ADD_CHECK_NG, "更新可访问的海关/商品编码格式不正确。"),
    USER_UPDATE_PRODUCT_NUMBER_IS_NOT_NUMERIC(ResponseCode.RESPONSE_CODE_USER_ADD_CHECK_NG, "更新可访问的海关/商品编码不是数字。"),

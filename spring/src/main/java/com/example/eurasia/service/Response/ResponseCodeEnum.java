...
public enum ResponseCodeEnum {
    ...
    USER_ADD_ID_IS_NULL(ResponseCode.RESPONSE_CODE_NG, "用户ID为空。"),
    USER_ADD_ID_IS_EXIST(ResponseCode.RESPONSE_CODE_NG, "用户ID已存在。"),
    USER_ADD_NAME_IS_NULL(ResponseCode.RESPONSE_CODE_NG, "用户名为空。"),
    USER_ADD_PHONE_IS_NULL(ResponseCode.RESPONSE_CODE_NG, "用户手机号码为空。"),
    USER_ADD_PHONE_IS_EXIST(ResponseCode.RESPONSE_CODE_NG, "用户手机号码已存在。"),
    USER_ADD_PHONE_FORMAT_ERROR(ResponseCode.RESPONSE_CODE_NG, "用户手机号码格式不正确。"),
    USER_ADD_VALID_FORMAT_ERROR(ResponseCode.RESPONSE_CODE_NG, "用户有效期格式不正确。"),
    USER_ADD_VALID_FROM_DATE_IS_NULL(ResponseCode.RESPONSE_CODE_NG, "用户起始有效期为空。"),
    USER_ADD_VALID_TO_DATE_IS_NULL(ResponseCode.RESPONSE_CODE_NG, "用户结束有效期为空。"),
    USER_ADD_PRODUCT_DATE_FORMAT_ERROR(ResponseCode.RESPONSE_CODE_NG, "可访问的日期范围格式不正确。"),
    USER_ADD_PRODUCT_DATE_FROM_DATE_IS_NULL(ResponseCode.RESPONSE_CODE_NG, "可访问的日期范围的起始有效期为空。"),
    USER_ADD_PRODUCT_DATE_TO_DATE_IS_NULL(ResponseCode.RESPONSE_CODE_NG, "可访问的日期范围的结束有效期为空。"),
    USER_ADD_PRODUCT_NUMBER_IS_NULL(ResponseCode.RESPONSE_CODE_NG, "可访问的商品编码为空。"),

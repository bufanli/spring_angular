...
public enum ResponseCodeEnum {
    ...
    USER_GET_BASIC_INFO_FROM_SQL_SUCCESS(ResponseCode.RESPONSE_CODE_OK, "从数据库取得用户信息成功"),
    USER_GET_BASIC_INFO_FROM_SQL_FAILED(ResponseCode.RESPONSE_CODE_NG, "从数据库取得用户信息失败"),
    USER_GET_BASIC_INFO_FROM_SQL_NULL(ResponseCode.RESPONSE_CODE_NULL, "从数据库取得用户信息为NULL"),
    USER_GET_BASIC_INFO_FROM_SQL_ZERO(ResponseCode.RESPONSE_CODE_OK, "从数据库取得用户信息为0"),

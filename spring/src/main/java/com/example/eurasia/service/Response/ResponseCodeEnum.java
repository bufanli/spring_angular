...
public enum ResponseCodeEnum {
    ...
    QUERY_CONDITION_DATE_DEFAULT_VALUE_WRONG(ResponseCode.RESPONSE_CODE_OK, "从数据库取得日期默认值错误"),
    QUERY_CONDITION_TYPE_FROM_SQL_SUCCESS(ResponseCode.RESPONSE_CODE_OK, "从数据库取得查询条件类型成功"),
    QUERY_CONDITION_TYPE_FROM_SQL_FAILED(ResponseCode.RESPONSE_CODE_NG, "从数据库取得查询条件类型失败"),
    QUERY_CONDITION_TYPE_FROM_SQL_NULL(ResponseCode.RESPONSE_CODE_NULL, "从数据库取得查询条件类型为NULL"),
    QUERY_CONDITION_TYPE_FROM_SQL_SIZE_ERROR(ResponseCode.RESPONSE_CODE_OK, "从数据库取得查询条件类型条数错误"),
    QUERY_CONDITION_LIST_VALUE_FROM_SQL_SUCCESS(ResponseCode.RESPONSE_CODE_OK, "从数据库取得List型查询条件的值成功"),
    QUERY_CONDITION_LIST_VALUE_FROM_SQL_FAILED(ResponseCode.RESPONSE_CODE_NG, "从数据库取得List型查询条件的值失败"),
    QUERY_CONDITION_LIST_VALUE_FROM_SQL_NULL(ResponseCode.RESPONSE_CODE_NULL, "从数据库取得List型查询条件的值为NULL"),
    QUERY_CONDITION_LIST_VALUE_FROM_SQL_ZERO(ResponseCode.RESPONSE_CODE_OK, "从数据库取得List型查询条件的值为0"),
    ...
    GET_EXCEL_REPORT_CONDITION_FAILED(ResponseCode.RESPONSE_CODE_NG, "取得Excel报表的过滤条件失败"),
    GET_EXCEL_REPORT_CONDITION_DATE_USER_DEFAULT_VALUE_WRONG(ResponseCode.RESPONSE_CODE_OK, "取得Excel报表的过滤条件,从数据库取得用户的日期默认值错误"),
    GET_EXCEL_REPORT_CONDITION_DATE_DEFAULT_VALUE_WRONG(ResponseCode.RESPONSE_CODE_OK, "取得Excel报表的过滤条件,从数据库取得日期默认值错误"),
    GET_EXCEL_REPORT_TYPES_SUCCESS(ResponseCode.RESPONSE_CODE_OK, "取得Excel报表的汇总类型成功"),
    GET_EXCEL_REPORT_TYPES_FAILED(ResponseCode.RESPONSE_CODE_NG, "取得Excel报表的汇总类型失败"),
    EXPORT_EXCEL_REPORT_SUCCESS(ResponseCode.RESPONSE_CODE_OK, "导出报表成功"),
    EXPORT_EXCEL_REPORT_FAILED(ResponseCode.RESPONSE_CODE_NG, "导出报表失败"),
    ...
    IMPORT_DATA_DICTIONARY_NAME_NULL(ResponseCode.RESPONSE_CODE_NULL, "导入数据对应关系的词典的名字为空"),
    IMPORT_DATA_DICTIONARY_IS_NOT_EXIST(ResponseCode.RESPONSE_CODE_NULL, "导入数据对应关系的词典不存在"),
    IMPORT_DATA_DICTIONARY_GET_HEADER_INFO_FROM_SQL_NULL(ResponseCode.RESPONSE_CODE_NULL, "导入数据对应关系的词典时,从数据库取得表头信息为NULL"),
    IMPORT_DATA_DICTIONARY_HEADER_IS_NOT_EXIST(ResponseCode.RESPONSE_CODE_NULL, "导入数据对应关系的词典时,字段名不在数据库中,请插入字段:"),
    ...
    EXPORT_DATA_DICTIONARY_FAILED(ResponseCode.RESPONSE_CODE_NULL, "导出数据对应关系的词典失败"),
    EXPORT_DATA_DICTIONARY_DELETE_TEMP_FILE_FAILED(ResponseCode.RESPONSE_CODE_NULL, "导出数据对应关系的词典时，删除临时文件失败"),
    EXPORT_DATA_DICTIONARY_GET_HEADER_INFO_FROM_SQL_NULL(ResponseCode.RESPONSE_CODE_NULL, "取得数据对应关系的词典时,从数据库取得表头信息为NULL"),
    EXPORT_DATA_DICTIONARY_GET_DATA_INFO_FROM_SQL_NULL(ResponseCode.RESPONSE_CODE_NULL, "取得数据对应关系的词典时,从数据库取得数据信息为NULL"),
